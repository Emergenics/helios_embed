// --- START OF FILE src/helios_embed/helios_embed_pybind.cpp (FINAL v2.5.0 with CPU Guards) ---
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // The get_build_info function is always available, for both CPU and CUDA builds.
...
// --- END OF FILE src/helios_embed/helios_embed_pybind.cpp (FINAL v2.5.0 with CPU Guards) ---