...
/**
 * @brief Validates input tensors for the stateless Nystrom feature embedding
 * function. Throws informative C++ exceptions (mapped to Python exceptions) on
 * failure. This is the primary security gate for the stateless API.
 */
 ...
 * @param ridge The regularization parameter for the kernel matrix. Must be >=
 * 0.
